...
const eS = { marginTop: '16px', width: '99%', marginLeft: '1%', textAlign: 'left', fontWeight: 700, color: '#b33939', fontSize: '12px', marginBottom: '12px' };
const iS = { marginTop: '16px', width: '99%', textAlign: 'left', fontWeight: 700, color: '#0a3d62', fontSize: '12px' };
