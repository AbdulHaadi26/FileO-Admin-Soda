...
export default ({ list, id, isList, ord, setCID, setMUpt, setMD }) => {
    ...
    return <div style={{ width: '100%', display: 'flex', flexDirection: 'row', flexWrap: 'wrap', marginTop: '20px' }}>{renderList()}</div>
