...
import { fetchCatModal, moveCat, copyCat } from '../../../../redux/actions/categoryActions';
import Loader from '../../../loader/simpleLoader';
import ModalBg from '../../../containers/modalBgContainer';
import { cutFile, copyFile } from '../../../../redux/actions/fileActions';
...
const Modal = ({
    ...
    const BreadCrumb = () => {
        if (catData && catData.cat) {
            return <>
                <h6 onClick={e => setSId('')} style={{ fontWeight: '600', fontSize: '12px', marginRight: '3px', cursor: 'pointer', color: '#0000EE' }}>Admin Files</h6>
        ...
        return <h6 onClick={e => setSId('')} style={{ fontWeight: '600', fontSize: '12px', marginRight: '6px', cursor: 'pointer', color: '#0000EE' }}>Admin Files</h6>
    };
