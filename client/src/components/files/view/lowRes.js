...
const mT = { marginTop: '12px', marginBottom: '24px' };
...
export default ({ name, type1, type2, url1, disabled, url2, ver1, ver2, cmp, width, version, version2, p1, p2, d1, d2, desc1, desc2, i1, i2, id1, id2, onhandleSelect, onhandleSelect2 }) => <>
