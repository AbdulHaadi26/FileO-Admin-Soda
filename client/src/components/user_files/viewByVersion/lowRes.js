...
export default ({ org, postedby, name, type1, type2, url1, url2, ver1, ver2, cmp, width, version, version2, p1, p2, d1, d2, desc1, desc2, i1, i2, id1, id2, onhandleModal, onhandleSelect, onhandleSelect2 }) => <>
    <div className="f-v-w" style={mT}>
        ...
        <ButtonDown postedby={postedby} org={org} id={id1} url={url1} showModal={onhandleModal} mT='-0px 6px 0px 0px' />
    </div>
    <div className="f-v-w">
    ...
    <div className="f-v-w" style={mT}>
        <select className="custom-select col-9 mt-4" onChange={e => onhandleSelect2(e)} defaultValue={`Version ${ver2}`}>
            {renderOptions(version2)}
        </select>
        <ButtonDown postedby={postedby} org={org} id={id2} url={url2} showModal={onhandleModal} mT='-0px 6px 0px 0px' />
    </div>
    <div className="f-v-w">
        <div className="col-12 p-1"><Suspense fallback={<></>}>
            <div style={dF}>
