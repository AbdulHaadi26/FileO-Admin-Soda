...
export default ({ name, type1, type2, url1, url2, ver1, ver2, cmp, width, version, version2, p1, p2, d1, d2, desc1, desc2, i1, i2, id1, id2, onhandleSelect, onhandleSelect2 }) => <>
    <div className="f-v-w" style={mT}>
        <select className="custom-select col-12" onChange={e => onhandleSelect(e)} defaultValue={`Version ${ver1}`}>
            {renderOptions(version)}
        </select>
        <ButtonDown id={id1} url={url1} mT='-0px' />
    </div>
    <div className="f-v-w">
        <div className="col-12 p-1"><Suspense fallback={<></>}>
            <div style={dF}>
                <img src={i1 ? i1 : User} alt="user" style={iS} />
                <h6 className="date mr-auto">{p1}</h6>
    ...
    <div className="f-v-w" style={mT}>
        <select className="custom-select col-12 mt-4" onChange={e => onhandleSelect2(e)} defaultValue={`Version ${ver2}`}>
    ...
    <div className="f-v-w">
        <div className="col-12 p-1"><Suspense fallback={<></>}>
            <div style={dF}>
                ...
                <h6 className="date mr-auto">{p2}</h6>
