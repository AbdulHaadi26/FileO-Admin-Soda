...
import { updateOrganizationImage } from '../../redux/actions/organizationActions';
import { uploadEmpImage } from '../../redux/actions/employeeActions';
...
const EditImage = ({ handleModal, val, name, head, num, modal, org, refAct, uploadImage, updateOrganizationImage, uploadEmpImage, id, imgSize }) => {
    ...
    const chooseReference = () => {
        var data = { id: id, org: org, image: iN, mimeType: mT, fileSize: s };
        switch (refAct) {
            case 'profile': uploadImage(data, i, id); break;
            case 'organization': updateOrganizationImage(data, i, id); break;
            case 'employee': uploadEmpImage(data, i, id); break;
            default: break;
        }
    }
...
export default connect(null, { uploadImage, updateOrganizationImage, uploadEmpImage })(EditImage);