...
export default ({ onhandleModal, onhandleUpt, txt, desc }) => {
    ...
    return <Modal handleModal={onhandleModal} isOpt={true}>
        <form onSubmit={e => {
            ...
            <h3 style={{ fontWeight: '600', fontSize: '18px', padding: '6px 12px', marginTop: '12px', marginBottom: '12px' }}>Edit Annoucement</h3>
            <hr />
            <div className="col-12" style={{ padding: '6px 12px' }}>
                ...
                <div className="input-group" style={iG}>
                    <input type={'text'} className="form-control" placeholder={'Announcement name'} value={text}
                ...
                <div className="input-group" style={{ width: '100%', marginTop: '12px' }}>
                    <textarea type='text' className="form-control" placeholder={'Annoucement description'} value={description} onChange={e => onhandleInputA(e)} style={tS} />
                </div>
