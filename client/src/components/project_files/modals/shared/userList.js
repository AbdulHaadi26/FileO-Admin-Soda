...
import { registerEmp } from '../../../../redux/actions/project_categoryActions';
import { connect } from 'react-redux';
import Plus from '../../../../assets/plusB.svg';
import User from '../../../../assets/static/user.png';

const List = ({ onFetch, list, count, cId, registerEmp, getList }) => {

    const handleAdd = async user => {
        let data = { cId: cId, _id: user._id };
        await registerEmp(data);
        getList();
    };
