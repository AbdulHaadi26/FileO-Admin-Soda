...
const View = ({ disabled, File, getF, AddToF, DelToF, tabNav, setTN, ver, discussion, updated, profile, count, offset, setOF, addComment, updateChat, downloadFile }) => {
    ...
    return <div className="col-11 p-0 f-w">
        ...
        {!cmp && <div style={{ display: 'flex', flexDirection: 'row', flexWrap: 'wrap', alignItems: 'flex-start' }}>
            ...
            <Discussion id={versionId} message={message} setMessage={setMessage} updateChat={updateChat} count={count} profile={profile} isEdt={false} isP={true} isPM={true}
