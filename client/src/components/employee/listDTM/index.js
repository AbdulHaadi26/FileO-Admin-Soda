...
import GTrans from '../../../assets/tabnav/G-Transfer to.svg';
import BTrans from '../../../assets/tabnav/B-transfer to.svg';
import GTransfer  from '../../../assets/tabnav/G-transfer.svg';
import BTransfer from '../../../assets/tabnav/B-transfer.svg';
import Searchbar from '../../searchbarReusable';

let icons = [
    { G: GTrans, B: BTrans },
    { G: GTransfer, B: BTransfer }
];
...
const ListUser = ({
    ...
    return <div className="col-11 e-w p-0">
        ...
        <Tabnav items={['Transfer To', 'Transfer']} i={tabNav} setI={setTN} icons={icons} />
        {tabNav === 0 && <>
