...
const Dashboard = ({ data, profile, catId, registerReq, registerPlan, registerProject }) => {
    ...
    return <div className="col-11 d-w p-0">
        ...
        <div className="col-12 p-0 dsh p-0">
            {<Suspense fallback={<></>}><Dash r={projectCount} f={fileCount} _id={profile && profile._id} or={current_employer} org={current_employer && current_employer._id} /></Suspense>}
        </div>
        ...
        <div style={{ width: '100%', display: 'flex', flexDirection: 'row', justifyContent: 'flex-end' }}>
            <Link style={{ marginTop: '16px', fontWeight: '600', marginRight: '12px', fontSize: '16px' }}
