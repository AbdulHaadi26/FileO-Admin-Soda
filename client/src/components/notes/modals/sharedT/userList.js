...
import { registerTask } from '../../../../redux/actions/sharedTasksActions';
import { connect } from 'react-redux';
import Plus from '../../../../assets/plusB.svg';
import User from '../../../../assets/static/user.png';

const List = ({ onFetch, list, count, nId, org, registerTask }) => {
...
export default connect(null, { registerTask })(List);