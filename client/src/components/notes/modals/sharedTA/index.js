...
import { fetchAssigned, fetchAssignedSearch, deleteAssignedAll } from '../../../../redux/actions/sharedTasksActions';
...
const List = ({
    ...
    return <Modal handleModal={onhandleModal}>
        <h3 style={{ fontWeight: '600', fontSize: '18px', marginTop: '12px', marginBottom: '12px', padding: '6px 12px' }}>{isTask ? 'Task' : 'Note'} Participant</h3>
        <hr />
