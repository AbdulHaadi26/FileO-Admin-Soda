...
import { delEmployee } from '../../../../redux/actions/projectActions';
import Minus from '../../../../assets/minus.svg';
import { connect } from 'react-redux';
import User from '../../../../assets/static/user.png';
const List = ({ list, count, pId, delEmployee, onFetch, getList }) => {

    const handleDelete = async user => {
        let data = { _id: user ? user._id : '', pId };
        await delEmployee(data);
        getList();
    };

    const renderListF = () => list.map(i => <div className="col-lg-2 col-4 mFWS" key={i._id}>
...
export default connect(null, { delEmployee })(List);