...
import { fetchPlans } from '../../redux/actions/personal/planActions';
import { getPlanAll } from '../../redux/actions/personal/dailyPlanActions';
const List = lazy(() => import('../../componentsP/plans/list'));
