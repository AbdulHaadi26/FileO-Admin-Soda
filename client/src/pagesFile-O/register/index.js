...
import { checkEmail, getPackages, registerFileO, getCodes } from '../../redux/actions/file-OActions';
...
const Contact = ({ getPackages, c, pkgs, registerFileO, getCodes }) => {
    ...
    const submitForm = async e => {
        ...
        if ((reCE.test(eM) && !reWS.test(eM)) && (rP.test(p) && !reWS.test(p) && p !== eM) && pl >= 3 && pkg && capt) {
            ...
            let data = {
                ...
                package: pkg._id, price: pkg ? ((pl * Number(pkg.pricePerUser)) + Number(pkg.price)) : 0
            };

            let orderId = await registerFileO(data);
            setOId(orderId);
        }
    };
                        ...
                        <div className="col-lg-7 contact-row">
                            <form className="form" onSubmit={submitForm}>
                                ...
                                <div className="col-lg-4 col-12" style={{ marginTop: '12px' }}>
                                    ...
                                    <div className="input-group shadow">
                                        <input type="number" className="form-control" min={0} style={{ width: '100%' }} placeholder="" required
                                ...
                                <div className="col-lg-4 col-12" style={{ marginTop: '12px' }}>
                                    ...
                                    <div className="input-group shadow">
                                        <input type="number" min={0} max={5000} step={50} className="form-control" style={{ width: '100%' }} placeholder="" required
                                ...
                                <div className="col-lg-4 col-12" style={{ marginTop: '12px' }}>
                                    ...
                                    <div className="input-group shadow">
                                        <input type="text" disabled className="form-control" style={{ width: '100%' }} placeholder="" required
                                            value={`${pkg ? ((pl * Number(pkg.pricePerUser)) + Number(pkg.price)) : 0}`}
                                        />
                                        <div className="input-group-append">
...
export default connect(mapStateToProps, { getPackages, registerFileO, getCodes })(Contact);