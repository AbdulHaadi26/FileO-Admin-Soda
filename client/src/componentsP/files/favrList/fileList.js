...
export default ({ list, id, uId, ord, isList }) => {
    ...
    const getBaseUrl = (pId, type) => type === 0 ? `/organization/${id}/file/` : type === 1 ? `/organization/${id}/projects/${pId}/version/file/` : type === 2 ? `/personal/myspace/user/${uId}/file/` : `/personal/user/${uId}/clients/file/`
