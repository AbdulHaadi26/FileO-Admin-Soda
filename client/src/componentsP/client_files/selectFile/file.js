...
export default ({ value, size, errSelected, errFile, errBroken, onhandleFilePreview }) => <>
    ...
    {renderError(size, errBroken, errSelected, errFile)}
</>

const renderError = (size, errBroken, errSelected, errFile) => errSelected ? <div className="mr-auto" style={eS}> No file selected</div> : errFile ? <div className="mr-auto" style={eS}> File size exceeds the limit</div>
