...
const List = ({
    ...
    const setTNB = (n) => {
        history.push(`/personal/bill/list/page/${n}`);
        setTN(n)
    };
    ...
    return <div className="col-11 p-w p-0">
        ...
        {bill && profile && <ViewBill setOId={setOId} width={width} onhandleModal={e => setBill(false)} Bill={bill} profile={profile && profile.user} />}
    </div>
}
