...
const View = ({ File, AddToF, DelToF, tabNav, setTN, ver, downloadFile, generateUrl, disabled }) => {
    ...
    if (File && File.file) var { versionId } = File.file;
...
export default connect(null, { AddToF, DelToF, generateUrl, downloadFile })(View);