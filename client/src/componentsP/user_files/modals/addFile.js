...
import { registerFile } from '../../../redux/actions/personal/userFilesActions';
import '../style.css';
...
const Add = ({ setting, registerFile, _id, catId, onhandleModal }) => {
    ...
    const handleSubmit = e => {
        ...
        if (name && fS && !errB) {
            ...
            let data = {
                 name: name, size: size, mime: mimeT, postedby: _id, category: catId, type: type,
