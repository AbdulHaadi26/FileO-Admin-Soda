...
import { registerCat } from '../../../../redux/actions/sharedCatActions';
import { connect } from 'react-redux';
import Plus from '../../../../assets/plusB.svg';
import User from '../../../../assets/static/user.png';
const List = ({ list, count, cId, org, registerCat, onFetch }) => {

    const handleAdd = (user) => {
        let data = { catId: cId, sWith: user._id, name: user.name, org: org };
        registerCat(data);
    };
...
export default connect(null, { registerCat })(List);