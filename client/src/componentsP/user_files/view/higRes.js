...
export default ({ disabled, postedby, org, name, type1, type2, url1, url2, ver1, ver2, cmp, width, version, version2, p1, p2, d1, d2, desc1, desc2, i1, i2, id1, id2, onhandleModal, onhandleSelect, onhandleSelect2 }) => <>
    <div className="f-v-w" style={mT}>
        ...
        <ButtonDown disabled={disabled} id={id1} url={url1} postedby={postedby} org={org} showModal={onhandleModal} mT='-0px 6px 0px 0px' />
        <ButtonDown disabled={disabled} id={id2} url={url2} postedby={postedby} org={org} showModal={onhandleModal} mT='-0px 0px 0px 6px' />
