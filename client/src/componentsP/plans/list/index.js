...
import { deletePlan, fetchPlans, fetchPlansSearch, registerPlan } from '../../../redux/actions/personal/planActions';
...
import { getPlanAll, getPlanD } from '../../../redux/actions/personal/dailyPlanActions';
...
const ListNote = ({
    fetchPlans, fetchPlansSearch, _id, planData, string, limit, limitMult, handleS, handleLM, handleL, tabNav, setTN, registerPlan,
    ...
    const handleAdd = (text, date) => {
        let data = { name: text, _id: _id, date };
        registerPlan(data);
    };
                ...
                <div className="col-lg-5 col-12" style={{ display: 'flex', flexDirection: 'column', alignSelf: 'stretch', alignItems: 'center' }}>
                    ...
                    <div style={{ width: '100%', display: 'flex', flexDirection: 'row', flexWrap: 'wrap' }}>
                        {list && list.length > 0 && count ?
                            <Suspense fallback={<></>}>
                                <List isList={isList} _id={_id} ord={ord} count={count}
