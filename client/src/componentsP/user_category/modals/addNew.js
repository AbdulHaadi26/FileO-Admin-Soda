...
import { registerFileNew, getFileDetailsM } from '../../../redux/actions/personal/userFilesActions';
import '../style.css';
...
const Add = ({ registerFileNew, userId, setting, Fl, verId, onhandleModal, getFileDetailsM }) => {
    ...
    const handleSubmit = e => {
        ...
        if (name && fS && !errB) {
            ...
            let data = {
                ...
                type: type, description: description ? description : '', fName: fName
            };
            onhandleModal();
