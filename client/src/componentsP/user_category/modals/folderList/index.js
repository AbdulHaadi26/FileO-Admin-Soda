...
import { fetchCatModal, moveCat, copyCat } from '../../../../redux/actions/personal/userCategoryActions';
import Loader from '../../../loader/simpleLoader';
import ModalBg from '../../../containers/modalBgContainer';
import { cutFile, copyFile } from '../../../../redux/actions/personal/userFilesActions';
...
const Modal = ({
    fetchCatModal, catData, onhandleModal, title, data, setCId, setSId, setMA, type, moveCat, cutFile, copyFile, copyCat, callFunc
}) => {
    ...
    const BreadCrumb = () => {
        if (catData && catData.cat) {
            return <>
                ...
                <h6 onClick={e => setSId('')} style={{ fontWeight: '600', fontSize: '12px', marginRight: '6px', cursor: 'pointer', color: 'v' }}>{'>'}</h6>
        ...
        return <h6 onClick={e => setSId('')} style={{ fontWeight: '600', fontSize: '12px', marginRight: '6px', cursor: 'pointer', color: 'gray' }}>My Space</h6>
    };
