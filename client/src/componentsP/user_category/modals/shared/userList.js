...
import { registerEmp } from '../../../../redux/actions/sharedFilesAction';
import { connect } from 'react-redux';
import Plus from '../../../../assets/plusB.svg';
import User from '../../../../assets/static/user.png';

const List = ({ onFetch, list, count, fId, org, registerEmp }) => {

    const handleAdd = user => {
        var data = { fileId: fId, sWith: user._id, name: user.name, org: org };
        registerEmp(data);
    };
