...
import { registerFileVer, getFileDetailsM } from '../../../redux/actions/personal/userFilesActions';
import '../style.css';
...
const tS = { marginTop: '16px', width: '100%', textAlign: 'left', fontSize: '12px' };
...
const Add = ({ setting, registerFileVer, getFileDetailsM, uId, verId, File, onhandleModal }) => {
    ...
    const handleSubmit = e => {
        ...
        if (name && fS && !errB) {
            ...
            setErrS(false);
            let data = {
                _id: verId, mime: mimeT, name: name, size: size, postedby: uId,
                category: tempId, active: true, type: type,
