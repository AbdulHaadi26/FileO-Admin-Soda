...
const TextArea = ({ modal, val, id, head, refAct, updateProfile, updateOrganization, name, title, handleModal, num, skip }) => {
...
export default connect(null, { updateProfile, updateOrganization })(TextArea);