...
function EditText({ refAct, updateProfile, updateOrganization, countryCode, catId, skip, updateEmpProfile, val, handleModal, id, name, org, head, type, title, num, modal, notEdit }) {
...
export default connect(null, { updateProfile, updateOrganization, updateEmpProfile })(EditText);