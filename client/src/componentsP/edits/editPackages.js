...
const EditText = ({ ModalProcess, handleModal, head, num, modal, len, updateSetting, Org, disabled }) => {
    ...
    return sM ? <div className="animated fadeIn faster">
        <div className="modal-content" style={mT}>
            ...
            <div className="modal-footer" style={mB}>
                ...
                <button type="button" className="btn btn-primary" disabled={disabled} onClick={e => handleUpdate()}>Add User Storage</button>
            </div>
        </div>
