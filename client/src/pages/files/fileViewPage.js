...
const ViewFile = lazy(() => import('../../components/files/view'));
...
const ViewPage = ({ match, getFile, profile, isSuc, file, isErr }) => {
    ...
    return <Container profile={profile} isSuc={isSuc && file} isErr={isErr} eT={'File Not Found'} num={9}> <ViewFile File={file} id={id} getF={getF} tabNav={tabNav} setTN={setTN} /> </Container>
}
